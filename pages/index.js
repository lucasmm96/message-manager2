...
function Home() {
  ...
  return (
    <>
      ...
      <p>As part of my web learning journey, this is an open source application developed to store citations, any art created to the message, and plan their publication on social networks.</p>
